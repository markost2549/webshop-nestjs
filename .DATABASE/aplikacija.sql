...
INSERT INTO `administrator` (`administrator_id`, `username`, `password_hash`) VALUES
	(1, 'marko', '0B26900D72D05393C0F71BCDF56FC2FD88ABEE1EC35F8B19AB9F69CDFB855281F557741D9971418BF166BB562F963B9995A559C4E67D28870D8DCBF8068BF9B5'),
	(2, 'newuser', 'adsdasasdsadasdsdadad'),
	(4, 'Marko3', '0B26900D72D05393C0F71BCDF56FC2FD88ABEE1EC35F8B19AB9F69CDFB855281F557741D9971418BF166BB562F963B9995A559C4E67D28870D8DCBF8068BF9B5'),
	...
	(10, 'test', 'C7AD44CBAD762A5DA0A452F9E854FDC1E0E7A52A38015F23F3EAB1D80B931DD472634DFAC71CD34EBC35D16AB7FB8A90C81F975113D6C7538DC69DD8DE9077EC');
...
INSERT INTO `article` (`article_id`, `name`, `category_id`, `excerpt`, `description`, `status`, `is_promoted`, `created_at`) VALUES
	(1, 'ACME HDD 512GB', 6, 'Kratak opis', 'Detaljan opis', 'available', 0, '2020-05-14 19:54:29'),
	(2, 'ACME HDD HD11 1024GB', 6, 'Jos jedan kratak opis proizvoda', 'Drugi detaljan opis proizvoda', 'visible', 1, '2020-05-15 10:44:33');
...
INSERT INTO `article_price` (`article_price_id`, `article_id`, `price`, `created_at`) VALUES
	(1, 1, 45.00, '2020-05-14 20:26:56'),
	(2, 1, 43.56, '2020-05-14 20:27:32'),
	(3, 2, 56.78, '2020-05-15 10:44:33'),
	(4, 2, 59.11, '2020-05-23 11:35:59');
...
INSERT INTO `cart` (`cart_id`, `user_id`, `created_at`) VALUES
	(1, 1, '2020-05-25 18:59:45'),
	(2, 1, '2020-05-25 19:04:31');
...
INSERT INTO `category` (`category_id`, `name`, `image_path`, `parent__category_id`) VALUES
	(2, 'Računarske komponente', 'assets/pc.jpg', NULL),
	(3, 'Kućna elektronika', 'assets/home.jpg', NULL),
	(4, 'Laptop računari', 'assets/pc/laptop.jpg', 2),
	(5, 'Memorijski mediji', 'assets/pc/memory.jpg', 2),
	(6, 'Hard diskovi', 'assets/pc/memory/hdd.jpg', 5);
...
INSERT INTO `order` (`order_id`, `created_at`, `cart_id`, `status`) VALUES
	(1, '2020-05-25 19:04:16', 1, 'shipped');
...
INSERT INTO `photo` (`photo_id`, `article_id`, `image_path`) VALUES
	(30, 2, '2020525-5868437535-hdd.png');
...
INSERT INTO `user` (`user_id`, `email`, `password_hash`, `firstname`, `lastname`, `phone_number`, `postal_address`) VALUES
	(1, 'test@test.rs', '397118FDAC8D83AD98813C50759C85B8C47565D8268BF10DA483153B747A74743A58A90E85AA9F705CE6984FFC128DB567489817E4092D050D8A1CC596DDC119', 'Pera', 'Peric', '+381621234657', 'Nepoznata adresa');
